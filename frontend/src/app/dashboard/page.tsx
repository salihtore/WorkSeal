...
import Navbar from "@/components/navbar"; // 1. YENİ: Navbar'ı içeri aktardık
...
export default function DashboardPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      {/* 2. YENİ: Sayfa içeriğini dikey (col) bir flex içine aldık */}
      <div className="flex flex-col flex-1">
        
        <Navbar /> {/* 3. YENİ: Üst menümüzü buraya yerleştirdik! */}
